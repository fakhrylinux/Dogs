...
import tech.fakhrylinux.dogs.databinding.SendSmsDialogBinding
import tech.fakhrylinux.dogs.model.DogBreed
import tech.fakhrylinux.dogs.model.DogPalette
import tech.fakhrylinux.dogs.model.SmsInfo
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_share -> {
                ...
                intent.putExtra(
                    Intent.EXTRA_TEXT,
                    "${currentDog?.dogBreed} breed for ${currentDog?.breedFor}"
                )
